...
public class ControladorBiseccion {
    ...
    public VistaMetodoBiseccion vista;
    public ModeloBiseccion modelo;

    public ControladorBiseccion(VistaMetodoBiseccion vista, ModeloBiseccion modelo) {
        this.vista = vista;
        this.modelo = modelo;
//        this.vista.btnResolver.addActionListener(e -> resolver());
    }
}
    //
